...
export default function generateSpinnerSegments(labels: string[]) {
  ...
  return labels.map((label, labelIndex) => {
    ...
    segmentElement.style.transform = createSegmentRotationString(
      labelIndex,
      labels.length,
    );
